...
<div class="wmufs_card_mini wmufs_mb_20">
    <div class="wmufs-title">
        <h3><?php esc_html_e('Get Free Elementor Addons Plugins', 'wp-maximum-upload-file-size') ?></h3>
        <div class="wmufs-recommended-content">
            <a href="<?php echo esc_url_raw('https://wordpress.org/plugins/unlimited-theme-addons/');?>" target="_blank">
                <img src="<?php echo esc_url(  WMUFS_PLUGIN_URL . 'assets/images/icon-128x128.png' ); ?>" alt="<?php echo esc_html('dostart');?>">
            </a>
            <div class="wmufs-btn">
