...
if ( ! function_exists( 'codepopular_dashboard_widget_render' ) ) {
	...
	function codepopular_dashboard_widget_render() {
		...
		if ( ! empty( $posts ) ) {
			...
			?>
			<hr>
			<p> <a style="text-decoration: none;font-weight: bold" href="<?php echo esc_url( 'https://codepopular.com/blog/' ); ?>?utm_source=unlimited-theme-addons" target=_balnk><?php echo esc_html__( 'Get more WordPress tips & news on our blog...', 'wp-maximum-upload-file-size' ); ?></a></p>
