...
* Description: Wp Maximum Upload File Size will increase upload limit with one click. You can avoid upload limitin to active this pluign.
* Author: CodePopular
* Author URI: https://profiles.wordpress.org/codepopular/
* Plugin URI: https://wordpress.org/plugins/wp-maximum-upload-file-size/
* Version: 1.0.3
* License: GPL2
* Text Domain: wp-max-upload-file-size
...
class Wp_Upload_Max_File_Size
{
  ...
  static function upload_max_file_size_dash()
  {
    ...
    echo '<div class="wrap">';
    echo '<h1><span class="dashicons dashicons-upload" style="font-size: inherit; line-height: unset;"></span> Wp Maximum Upload File Size</h1><br>';
...
add_action('init', array('Wp_Upload_Max_File_Size', 'init'));
